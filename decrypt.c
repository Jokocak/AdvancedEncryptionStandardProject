/**
        ...
        This file contains the main method for the decrypt program, this
        program uses all of the other components to perform AES decryption
        and to write out the plaintext output.
 */
...
/**
        ...
        perform AES decryption, and writes out the plaintext output.
...
int main( int argc, char *argv[] )
{
        ...
        if ( inputSize == BLOCK_SIZE ) {
                decryptBlock( inputBytes, keyBytes );
        } else {
